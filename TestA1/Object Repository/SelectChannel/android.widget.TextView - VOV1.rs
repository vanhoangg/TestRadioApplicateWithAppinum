...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - VOV1</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'VOV1' or . = 'VOV1') and @resource-id = 'com.example.radioonline:id/tvName']</locator>
