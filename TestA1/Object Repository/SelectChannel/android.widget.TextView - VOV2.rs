...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - VOV2</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'VOV2' or . = 'VOV2') and @resource-id = 'com.example.radioonline:id/tvName']</locator>
